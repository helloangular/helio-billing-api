...
"${scanner_command[@]}" \
  -Dproject.settings=scripts/parallel-apps/sonar-project.properties -Dsonar.projectKey="$APP_SLUG" -Dsonar.projectName="$APP_SLUG" -Dsonar.projectVersion="$project_version" \
