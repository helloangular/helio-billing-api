...
#   io/helio/payment-api-manual-test/<version>/payment-api-manual-test-<version>.war
#
...
group_path="io/helio/payment-api-manual-test"
artifact="payment-api-manual-test"
